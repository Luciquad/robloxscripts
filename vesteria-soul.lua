...
function library:Window(TitleWhite)
    ...
    BloxburgHubTitle.Text = "Cheater Soul"
...
Environment.Settings.HiddenName = "Vesteria Cheater Soul"
...
Sections.MiscRandom:Box("Hidden Name","Vesteria Cheater Soul", function(Value)
    if Value then
...
chat("Vesteria Cheater Soul loaded.\nMade by Luciquad#1111 and cheatersoul.com", Color3.new(1, 0.341176, 1))
